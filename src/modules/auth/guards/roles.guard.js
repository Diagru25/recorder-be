...
exports.RolesGuard = exports.checkPolicies = exports.CHECK_POLICY_KEY = void 0;
var common_1 = require("@nestjs/common");
var passport_1 = require("@nestjs/passport");
exports.CHECK_POLICY_KEY = 'check_policy';
var checkPolicies = function (action_code, module_code) {
    var obj = {
        action_code: action_code,
        module_code: module_code
    };
    return (0, common_1.SetMetadata)(exports.CHECK_POLICY_KEY, obj);
};
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        obj = this.reflector.get(exports.CHECK_POLICY_KEY, context.getHandler()) || { action_code: '', module_code: '' };
